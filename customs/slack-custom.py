...
class SlackBot(OutputChannel):
    ...
    async def _post_message(self, channel: Text, **kwargs: Any) -> None:
        if self.thread_id:
            ...
            non_cancellable_shield(await self.client.chat_postMessage(channel=channel, **kwargs))
    ...
    async def send_text_message(
        ...
        for message_part in text.strip().split("\n\n"):
            await non_cancellable_shield(self._post_message(
    ...
    async def send_text_with_buttons(
        ...
        **kwargs: Any,
        ...
        if len(buttons) > 5:
            ...
            return await non_cancellable_shield(self.send_text_message(recipient, text, **kwargs))
    ...
    async def send_custom_json(
        ...
        await non_cancellable_shield(self._post_message(channel=channel, **json_message))
...
class SlackInput(InputChannel):
    ...
    async def process_message(
        ...
        try:
            ...
            await non_cancellable_shield(on_new_message(user_msg))
    ...
    def blueprint(
        ...
        async def webhook(request: Request) -> HTTPResponse:
            ...
            if content_type == "application/json":
                ...
                return await non_cancellable_shield(self.process_message(
                    request,
                    on_new_message,
